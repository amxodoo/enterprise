...
``l10n_mx_edi_addenda_kuehne_nagel.l10n_mx_edi_addenda_kuehne_nagel``.  On
Odoo 19 the same external id is declared for model ``l10n_mx_edi.addenda``,
so loading the data file raises::

    For external id l10n_mx_edi_addenda_kuehne_nagel.l10n_mx_edi_addenda_kuehne_nagel
    when trying to create/update a record of model l10n_mx_edi.addenda found
    record of different model ir.ui.view
...
MODULE = "l10n_mx_edi_addenda_kuehne_nagel"
XMLID_NAME = "l10n_mx_edi_addenda_kuehne_nagel"
