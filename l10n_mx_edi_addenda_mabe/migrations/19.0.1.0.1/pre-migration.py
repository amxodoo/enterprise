...
``l10n_mx_edi_addenda_mabe.l10n_mx_edi_addenda_mabe``.  On Odoo 19 the same
external id is declared for model ``l10n_mx_edi.addenda``, so loading the data
file raises::

    For external id l10n_mx_edi_addenda_mabe.l10n_mx_edi_addenda_mabe when
...
MODULE = "l10n_mx_edi_addenda_mabe"
XMLID_NAME = "l10n_mx_edi_addenda_mabe"
